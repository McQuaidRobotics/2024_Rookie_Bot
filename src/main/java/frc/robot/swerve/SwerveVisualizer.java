...
public class SwerveVisualizer {
    ...
    private static class ModuleVisualizer {
        ...
        private static final double MAX_DRIVE_VELOCITY = 5.0;
        ...
        public void update(SwerveModuleState state) {
            ...
            var percent = (state.speedMetersPerSecond / MAX_DRIVE_VELOCITY);
    ...
    public SwerveVisualizer(Module... modules) {
        ...
        for (int i = 0; i < modules.length; i++) {
            moduleVisual[i] = new ModuleVisualizer(i);
            moduleVisual[i]
                    .getMechanism()
                    .initSendable(
                            getBuilder(
                                    "SwerveModules/Module[" + i + "]"));
        }
